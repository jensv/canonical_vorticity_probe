...
def mach_results(shot=1210818030, nsmooth=None, res='mach',
    ...
    tetra_4_broke=False, rj_set=[20, 20, 20, 20, 2],
    mds_start='probe3_'):
...
def plot_mach_results(shot=1210818030, second_shot=None, nsmooth=None, 
    ...
    data = mach_results(shot, 
        ...
        vtype, imin, k, tetra_4_broke=tetra_4_broke, second_shot=second_shot)
    do_plot = True
    if res.lower().startswith('isat'):
